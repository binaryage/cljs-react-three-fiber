(ns rtf-examples.demos.svg-loader
  (:require [cljs-bean.core :refer [bean ->js]]
            [rtf-examples.lib.ui :refer [<> $ defnc use-state use-memo use-effect <canvas>]]
            [rtf-examples.lib.rtf :refer [use-loader]]
            [rtf-examples.lib.misc :refer [svg-loader]]
